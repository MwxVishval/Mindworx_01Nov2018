...
//    clone_div.find('#reject_xml_file').attr({id: "reject_xml_file_" + id, class: "form-control reject-validate" + id});
    ...
    clone_div.find('#assignmnetinfo').attr({id: "assignmnetinfo_" + id, class:"CheckBoxClass_"+id, onclick: "saveReportFields()"});
    clone_div.find('#operationinfo').attr({id: "operationinfo_" + id, class:"CheckBoxClass_"+id, onclick: "saveReportFields()"});
    clone_div.find('#locationinfo').attr({id: "locationinfo_" + id, class:"CheckBoxClass_"+id, onclick: "saveReportFields()"});
    clone_div.find('#createinfo').attr({id: "createinfo_" + id, class:"CheckBoxClass_"+id, onclick: "saveReportFields()"});
    clone_div.find('#updateinfo').attr({id: "updateinfo_" + id, class:"CheckBoxClass_"+id, onclick: "saveReportFields()"});
    clone_div.find('#assetinfo').attr({id: "assetinfo_" + id, class:"CheckBoxClass_"+id, onclick: "saveReportFields()"});
    clone_div.find('#attachmentinfo').attr({id: "attachmentinfo_" + id, class:"CheckBoxClass_"+id, onclick: "saveReportFields()"});
    clone_div.find('#customerinfo').attr({id: "customerinfo_" + id, class:"CheckBoxClass_"+id, onclick: "saveReportFields()"});
...
//    alert(task_type);
        var updatedstatus='';
        var flagstatus='';
//        alert($('input[class="CheckBoxClass_'+task_type+'"]:checked').length);
//var otherChkBoxIds= $('input[class="CheckBoxClass"]:checked').attr('id');
//alert(otherChkBoxIds);
    if($('input[class="CheckBoxClass_'+task_type+'"]:checked').length > 0)
    {
        $('input[id=sendtasks_'+task_type+']').prop("checked",true);
//        $("#create_fields"+task_type).attr("style", "display:block");
        $("#createfieldsDiv"+task_type).attr("style", "display:block");
        
        flagstatus=1;
    }
    else
    {
        $('input[id=sendtasks_'+task_type+']').prop("checked",false);
//        $("#create_fields"+task_type).attr("style", "display:none");
        $("#createfieldsDiv"+task_type).attr("style", "display:none");
//         $('input[id=sndtsks_'+task_type+']').attr("style", "display:none");
            flagstatus=0;
            $('label[name*="createfieldsLabel'+task_type+'"]').remove();
            $('label[name*="dub_createfieldsLabel'+task_type+'"]').remove();
        $("#create_fields"+task_type).find('option:first').attr('selected', 'selected');
...
//    alert(updatedstatus);
    $.ajax({
        ...
        type: 'post',
        data: {field_name: field_name, ent_id: ent_id, task_type: task_type, updatedstatus: updatedstatus,flagstatus:flagstatus},
        dataType: 'json',
        success: function (res) {
            alert(res);
        }
...
//                             
  ...
  //==============================================================================================================
                        ...
                        for (var j = 0; j < reportfields.length; j++) {
                            var id = reportfields[j].task_type_id;

                    //============= old code issue in assetinfo ...is getting wrong status value......
                    //        $('#assignmnetinfo_' + id).attr('checked', reportfields[j].assetinfo == 1 ? true : false);
                    //============= new code issue solve in assetinfo ...is getting wrong status value......
                            $('#assignmnetinfo_' + id).attr('checked', reportfields[j].assignmnetinfo == 1 ? true : false);
                    //============= ===============================......        

                            $('#operationinfo_' + id).attr('checked', reportfields[j].operationinfo == 1 ? true : false);
                            $('#locationinfo_' + id).attr('checked', reportfields[j].locationinfo == 1 ? true : false);
                            $('#createinfo_' + id).attr('checked', reportfields[j].createinfo == 1 ? true : false);
                            $('#updateinfo_' + id).attr('checked', reportfields[j].updateinfo == 1 ? true : false);
                            $('#assetinfo_' + id).attr('checked', reportfields[j].assetinfo == 1 ? true : false);
                            $('#attachmentinfo_' + id).attr('checked', reportfields[j].attachmentinfo == 1 ? true : false);
                            $('#customerinfo_' + id).attr('checked', reportfields[j].customerinfo == 1 ? true : false);
                    //        alert( id);
...
//                            alert(reportflag[k].task_type_id);
                            ...
                            $('#sendtasks_'+reportflag[k].task_type_id).attr({onclick: "togtaskreport(id)", checked: "checked",obj:reportflag[k].task_type_id });
                    ...
                    //        alert(reportflagid);
                            ...
                            $('#sendtasks_'+reportflag[k].task_type_id).attr({onclick: "togtaskreport(id)", checked: "unchecked",obj:reportflag[k].task_type_id });
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                if (res.success) {
                    ...
                    create_no.push(res);
                    var htm = '<tr><td>' + res.Ext_att_name + '</td><td>' + res.Ext_att_type + '</td><td>' + res.Ext_att_size + '</td><td>' + selCategoryText + '</td><td><span id="remove_id' + res.extr_att_id + '" onclick="remove_row(' + res.extr_att_id + ')" name='+id+' class="glyphicon glyphicon-remove"></span></td></tr>';
...
function showCreate_Api_No() {
    for (var i = 0; i < create_no.length; i++) {
        var htm = '', option = '';
        htm += '<tr><td>' + create_no[i].Ext_att_name + '</td><td>' + create_no[i].Ext_att_type + '</td><td>' + create_no[i].Ext_att_size + '</td><td>' + create_no[i].category + '</td><td><span id="remove_id' + create_no[i].extr_att_id + '" onclick="remove_row(' + create_no[i].extr_att_id + ')" name="'+create_no[i].Task_type_ID+'" class="glyphicon glyphicon-remove"></span></td></tr>';
...
//alert($('#sendtasks_'+id).val());
     var ent_id = $('#ent_id').val();   
         if($('input[id='+id+']').is(":checked") == true) {
...
//                  });         
           ...
           else if($('input[id='+id+']').is(":not(:checked)"))
           {
