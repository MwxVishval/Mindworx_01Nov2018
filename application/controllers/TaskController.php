    ...
    public function savepdf() {
        ...
        if (isset($data['taskdetail'][0]['status_id'])) {
            switch ($data['taskdetail'][0]['status_id']) {
                case 1:
                    $data['taskdetail'][0]['status'] = 'Assigned';
                    break;
                case 2:
                    $data['taskdetail'][0]['status'] = 'On Hold';
                    break;
                case 3:
                    $data['taskdetail'][0]['status'] = 'Accepted';
                    break;
                case 4:
                    $data['taskdetail'][0]['status'] = 'Resolved';
                    break;
                case 5:
                    $data['taskdetail'][0]['status'] = 'In Progress';
                    break;
                case 6:
                    $data['taskdetail'][0]['status'] = "Canceled";
                    break;
                case 7:
                    $data['taskdetail'][0]['status'] = "Reject";
                    break;
                default:
                    $data['taskdetail'][0]['status'] = "not fount task status";
            }
        }
        ...
        if (isset($data['taskdetail'][0]['priority'])) {
            switch ($data['taskdetail'][0]['priority']) {
                case 1:
                    $data['taskdetail'][0]['priority_status'] = 'Critical';
                    break;
                case 2:
                    $data['taskdetail'][0]['priority_status'] = 'High';
                    break;
                case 3:
                    $data['taskdetail'][0]['priority_status'] = 'Moderate';
                    break;
                case 4:
                    $data['taskdetail'][0]['priority_status'] = 'Low';
                    break;
                case 5:
                    $data['taskdetail'][0]['priority_status'] = 'Planning';
                    break;

                default:
                    $data['taskdetail'][0]['priority_status'] = "not fount task priority";
            }
        }
