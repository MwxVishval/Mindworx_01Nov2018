...
//        }
    ...
    public function updateTaskScreen($taskid = NULL, $cat_id = NULL) {
        ...
        foreach ($result as $r) {
            ...
            $data[$i]['type_limit'] = $r['type_limit'];
            $data[$i]['required_status'] = $r['required_status'];
        /*    if (base64_encode($r['option_type']) == "U0VMRUNU") {
          ...
          if($taskdata){
            ...
            $admindata=$this->TaskModel->getAdminsection($taskid);
              if($admindata){
                ...
                $dataview=['taskdetail'=>$taskdata,'tasktype'=>$tasktype,'document'=>$document,'category'=>$category,'assets'=>$assets,'complete'=>$complete,
