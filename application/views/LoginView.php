            ...
            <div id="wrapper">
                <div id="login" class="animate form">
                    ...
                    <section class="login_content">
                        <form action="<?php echo base_url() ?>check" method="POST" id="Login_form" name="login">
                            <h1>Login</h1>
                            <div>
                            ...
                            <a class="reset_pass" href="<?php echo base_url(); ?>LoginController/forgot_password">Forget Password</a>
                             <div class="clearfix"></div>
                            <div class="separator">
                                <div class="clearfix"></div>
