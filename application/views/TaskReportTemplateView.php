                ...
                <div class="row" style="clear: both; width: 100%;">
                    ...
                    <div style="float: left; width: 70%; margin-left: 2%;">
                       ...
                       <div style="float: left; width: 40%;">
                                            ...
                                            <div style="word-break: break-all;text-align: left;"><b>Task Status: </b> <?php echo $taskdetail[0]['status'] ?> </div>
                                       
                                            <div style="word-break: break-all;text-align: left;"><b>Task Priority:</b>  <?php echo $taskdetail[0]['priority_status'] ?>  </div>
